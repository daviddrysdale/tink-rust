# Tink-Rust: Streaming Authenticated Encryption with Associated Data
...
This crate provides streaming authenticated encryption with associated data functionality, as described in the upstream
