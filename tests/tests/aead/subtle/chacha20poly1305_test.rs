...
#[test]
fn test_cha_cha20_poly1305_empty_associated_data() {
...
#[test]
fn test_cha_cha20_poly1305_long_messages() {
...
#[test]
fn test_cha_cha20_poly1305_random_nonce() {
    let key = get_random_bytes(tink_aead::subtle::CHA_CHA20_KEY_SIZE);
    let ca = subtle::ChaCha20Poly1305::new(&key).unwrap();
...
fn test_cha_cha20_poly1305_invalid_key() {
    let key = get_random_bytes(tink_aead::subtle::CHA_CHA20_KEY_SIZE - 1);
    let result = subtle::ChaCha20Poly1305::new(&key);
...
fn test_cha_cha20_poly1305_wycheproof_vectors() {
    ...
    for g in &data.test_groups {
        ...
        if (g.iv_size / 8) as usize != tink_aead::subtle::CHA_CHA20_NONCE_SIZE {
